...
(() => {
  ...
  async function n(a, l = {}) {
    ...
    delete a.headers?.["content-length"];
    let r = a.method.toLocaleLowerCase();
    if (!a.timeout) {
      a.timeout = 5;
    }
    if (a.timeout) {
  ...
  class i {
      ...
      switch (typeof e) {
        case "string":
          ...
          e.split("&").map(e => e.split("=")).forEach(([e, a]) => {
            this.#i.push(e ? decodeURIComponent(e) : e);
            this.#o.push(a ? decodeURIComponent(a) : a);
          });
          break;
        case "object":
          if (Array.isArray(e)) {
    ...
    delete(e, a) {
      while (this.#i.indexOf(e) > -1) {
        this.#o.splice(this.#i.indexOf(e), 1);
        this.#i.splice(this.#i.indexOf(e), 1);
      }
      this.#g(this.#i, this.#o);
    }
    entries() {
      return this.#i.map((e, a) => [e, this.#o[a]]);
    }
    get(e) {
      return this.#o[this.#i.indexOf(e)];
    }
    getAll(e) {
      return this.#o.filter((a, t) => this.#i[t] === e);
    }
    has(e, a) {
      return this.#i.indexOf(e) > -1;
    }
    keys() {
      return this.#i;
    }
    set(e, a) {
      if (this.#i.indexOf(e) === -1) {
        this.append(e, a);
      } else {
        let t = true;
        let s = [];
        this.#i = this.#i.filter((n, l) => n !== e ? (s.push(this.#o[l]), true) : !!t && (t = false, s.push(a), true));
        this.#o = s;
        this.#g(this.#i, this.#o);
      }
    }
  ...
  class o {
    ...
    set href(e) {
      ...
      let t = a.groups.authority.match(o.#p);
    ...
    set search(e) {
      ...
      this.#m.search = e;
      this.#m.searchParams = new i(this.#m.search);
    }
    get searchParams() {
    ...
    static parse(e = new String(), a = "") {
      ...
      return function e(a, t) {
        ...
        switch (typeof a) {
          ...
          case "object":
            ...
            r = i || (g ? function (e, a) {
              ...
              for (let e = 0; e < i; e++) {
                ...
                if (g < 0) {
                  ...
                  n = i.substr(g + 1).replace(/^\s+/, "");
                  i = s + i.substr(0, g).replace(/\s+$/, "");
                  let e = n[0];
                  if (e === n[n.length - 1] && (e === "'" || e === "\"")) {
            ...
            if (o === "plist") {
              r = Object.assign(r, function e(a, t) {
                let s;
                switch (typeof a) {
                  case "string":
                  case "undefined":
                  ...
                  case "object":
                    ...
                    switch (n) {
                      case "plist":
                        s = Object.assign(s, e(l[0], t));
                        break;
                      case "dict":
                        let r = l.map(a => e(a, t));
                        s = Object.fromEntries(r = function (e, a) {
                          for (var t = 0, s = []; t < e.length;) {
                            s.push(e.slice(t, t += 2));
                          }
                          return s;
                        }(r, 2));
                        break;
              ...
              u?.forEach?.((a, s) => {
                if (typeof a == "string") {
                  c(r, n, e(a, t), undefined);
                } else if (a.tag || a.children || a.raw) {
                  c(r, a.name, e(a, t), undefined);
                } else {
                  c(r, a.name, e(a, t), u?.[s - 1]?.name);
                }
              });
            }
            if (u && u.length === 0) {
              c(r, n, null, undefined);
            }
            if (t) {
              r = t(o || "", r);
            }
        ...
        let a = e.replace(/^[ \t]+/gm, "").split(/<([^!<>?](?:'[\S\s]*?'|"[\S\s]*?"|[^'"<>])*|!(?:--[\S\s]*?--|\[[^\[\]'"<>]+\[[\S\s]*?]]|DOCTYPE[^\[<>]*?\[[\S\s]*?]|(?:ENTITY[^"<>]*?"[\S\s]*?")?[\S\s]*?)|\?[\S\s]*?\?)>/);
        let t = a.length;
        let s = {
          children: []
        };
        ...
        for (let e = 0; e < t;) {
          ...
          if (s) {
            (function (e) {
              ...
              switch (t[0]) {
                case "/":
                  let o = e.replace(/^\/|[\s\/].*$/g, "").toLowerCase();
                  while (r.length) {
                ...
                case "!":
                  if (/!\[CDATA\[(.+)\]\]/.test(e)) {
                    l.name = "!CDATA";
                    l.raw = e.match(/!\[CDATA\[(?<raw>.+)\]\]/)?.groups?.raw;
                  } else if (/!--(.+)--/.test(e)) {
                    l.name = "!--";
                    l.raw = e.match(/!--(?<raw>.+)--/)?.groups?.raw;
                  } else {
                    l.name = t;
                    l.raw = a.join(" ");
                  }
      ...
      function l(e) {
        return e.replace(/(&(?:lt|gt|amp|apos|quot|#(?:\d{1,6}|x[0-9a-fA-F]{1,5}));)/g, function (e) {
          if (e[1] === "#") {
            let a = e[2] === "x" ? parseInt(e.substr(3), 16) : parseInt(e.substr(2), 10);
            if (a > -1) {
...
`, "");
                ...
                for (let e in a) {
                  if (e[0] === t) {
                    i += ` ${e.substring(1)}="${a[e].toString()}"`;
                    delete a[e];
                  } else if (a[e] === undefined) {
                    n = e;
                  } else {
                    o = true;
                  }
                    ...
                    r += function e(a, t, s) {
                      ...
                      switch (typeof a) {
                        case "boolean":
                          ...
                          break;
                        case "number":
                          n = `${s}<real>${a.toString()}</real>`;
                          break;
                        case "bigint":
                          n = `${s}<integer>${a.toString()}</integer>`;
                          break;
                        case "string":
                          n = `${s}<string>${a.toString()}</string>`;
                          break;
                        case "object":
                          let l = "";
                          if (Array.isArray(a)) {
...
`);
          ...
          case "STYLE":
            {
              let t = e.split(/\r\n|\r|\n/);
              t.shift();
              n.style = t.join(a.lineBreak);
              break;
            }
          default:
            let s = e.match(t)?.groups;
            if (s) {
              if (n.headers?.type !== "WEBVTT") {
                s.timing = s?.timing?.replace?.(",", ".");
                s.startTime = s?.startTime?.replace?.(",", ".");
                s.endTime = s?.endTime?.replace?.(",", ".");
              }
              if (a.timeStamp) {
                let e = s?.startTime?.replace?.(/(.*)/, "1970-01-01T$1Z");
                s.timeStamp = a.milliseconds ? Date.parse(e) : Date.parse(e) / 1000;
              }
    ...
    static stringify(e = {
      ...
      return [e.headers = [e.headers?.type || "", e.headers?.options || ""].flat(Infinity).join(a.lineBreak), e.comments = e?.comments?.join?.(a.lineBreak), e.style = e?.style?.length > 0 ? ["STYLE", e.style].join(a.lineBreak) : "", e.body = e.body.map(e => {
        if (Array.isArray(e.text)) {
          e.text = e.text.join(a.lineBreak);
        }
        return e = `${e.index ? e.index + a.lineBreak : ""}${e.timing} ${e?.settings ?? ""}${a.lineBreak}${e.text}`;
      }).join(a.lineBreak + a.lineBreak)].join(a.lineBreak + a.lineBreak).trim() + a.lineBreak + a.lineBreak;
    }
  }
  let c = {
    Universal: {
  ...
  class m {
    constructor(e = {}) {
      ...
      a.log(`🟧 ${this.Name} v${this.Version}`);
    }
    JSON(e = {}, t = {}, s = "captions", n = this.Offset, l = this.Tolerance, r = this.Position) {
      a.log("☑️ Composite JSON Subtitles", `Offset:${n}`, `Tolerance:${l}`, `Position:${r}`);
      let i = 0;
      let o = 0;
      let g = 0;
      let u = e?.events?.length;
      let c = t?.events?.length;
      for (s === "asr" && (a.info("DualSub是自动生成字幕"), i = 1, o = 1, g = 1, e.events = e.events.map(e => {
        if (e?.segs && Array.isArray(e?.segs)) {
          e.segs = [{
        ...
        let a = e.events[o].tStartMs;
        let s = t.events[g].tStartMs;
        let n = e.events[o + 1]?.tStartMs ?? a;
        let u = t.events[g + 1]?.tStartMs ?? s;
        if (Math.abs(a - s) <= l) {
          i = o;
          let a = e.events[o]?.segs?.[0].utf8 ?? "";
          let s = t.events[g]?.segs?.[0].utf8 ?? "";
          e.events[i].segs = [{
            utf8: (r === "Reverse" ? `${s}
${a}` : `${a}
${s}`).trim()
      ...
      a.log("✅ Composite JSON Subtitles");
      return e;
    }
    timedText(e = {}, t = {}, s = "captions", n = this.Offset, l = this.Tolerance, r = this.Position) {
      a.log("☑️ Composite timedText Subtitles", `Offset: ${n}`, `Tolerance: ${l}`, `Position: ${r}`);
      let i = 0;
      let o = 0;
      let g = 0;
      let u = e?.timedtext?.body?.p?.length;
      let c = t?.timedtext?.body?.p?.length;
      for (s === "asr" && (a.info("DualSub是自动生成字幕"), e.timedtext.head.wp[1]["@rc"] = "1", e.timedtext.body.p = e.timedtext.body.p.map(e => {
        if (e?.s) {
        ...
        return e;
      }), t.timedtext.body.p = t.timedtext.body.p.map(e => {
        if (e?.s) {
          if (Array.isArray(e?.s)) {
            e["#"] = e?.s.map(e => e["#"]).join("");
          } else {
        ...
        let a = parseInt(e.timedtext.body.p[o]["@t"], 10);
        let s = parseInt(t.timedtext.body.p[g]["@t"], 10);
        let n = parseInt(e.timedtext.body.p[o + 1]?.["@t"] ?? a, 10);
        let u = parseInt(t.timedtext.body.p[g + 1]?.["@t"] ?? s, 10);
        if (Math.abs(a - s) <= l) {
          i = o;
          let a = e.timedtext.body.p[o]?.["#"] ?? "";
          let s = t.timedtext.body.p[g]?.["#"] ?? "";
          e.timedtext.body.p[i]["#"] = (r === "Reverse" ? `${s}&#x000A;${a}` : `${a}&#x000A;${s}`).trim();
        }
        if (Math.abs(n - u) <= l) {
          o++;
          g++;
      ...
      a.log("✅ Composite timedText Subtitles");
      return e;
    }
    webVTT(e = {}, t = {}, s = this.Offset, n = this.Tolerance, l = this.Position) {
      a.log("☑️ Composite webVTT Subtitles", `Offset: ${s}`, `Tolerance: ${n}`, `Position: ${l}`);
      let r = 0;
      let i = 0;
      let o = 0;
      let g = e?.body?.length;
      let u = t?.body?.length;
      while (i < g && o < u) {
        let a = e.body[i].timeStamp;
        let s = t.body[o].timeStamp;
        let g = e.body[i + 1]?.timeStamp ?? a;
        let u = t.body[o + 1]?.timeStamp ?? s;
        let c = e.body[i]?.text ?? "";
        let m = t.body[o]?.text ?? "";
        if (Math.abs(a - s) <= n) {
          r = i;
          e.body[r].text = (l === "Reverse" ? `${m}
${c}` : `${c}
${m}`).trim();
        }
        if (Math.abs(g - u) <= n) {
      ...
      a.log("✅ Composite webVTT Subtitles");
      return e;
    }
    spotifyLyric(e = [], t = [], s = this.Offset, n = this.Tolerance, l = this.Position) {
      a.log("☑️ Composite Spotify Lyrics", `Offset: ${s}`, `Tolerance: ${n}`, `Position: ${l}`);
      let r = 0;
      let i = 0;
      let o = 0;
      let g = e?.length;
      let u = t?.length;
      while (i < g && o < u) {
        let a = e[i].startTimeMs;
        let g = t[o].startTimeMs + s;
        let u = e[i + 1]?.startTimeMs ?? a;
        let c = t[o + 1]?.startTimeMs + this.Offset ?? g;
        let m = e[i]?.words ?? "";
        let d = t[o]?.words ?? "";
        if (Math.abs(a - g) <= n) {
          e[r = i].words = (l === "Reverse" ? `${d}
${m}` : `${m}
${d}`).trim();
          e[r].owords = m.trim();
          e[r].twords = d.trim();
      ...
      a.log("✅ Composite Spotify Lyrics");
      return e;
    }
  }
  let d = new o($request.url);
  a.info(`url: ${d.toJSON()}`);
  let p = d.pathname.split("/").filter(Boolean);
  a.info(`PATHs: ${p}`);
  let h = ($response.headers?.["Content-Type"] ?? $response.headers?.["content-type"])?.split(";")?.[0];
  if (h === "application/octet-stream" || h === "text/plain") {
    h = function (e, t, s) {
      a.log("☑️ detectFormat", `format: ${e.format || e.searchParams.get("fmt") || e.searchParams.get("format")}`);
  ...
  (async () => {
    ...
    let {
      ...
      let {
        ...
        (function e(a, t) {
          ...
          if (a === "true" || a === "false") {
            ...
            a = a.includes(",") ? a.split(",").map(e => r(e)) : r(a);
          }
          return a;
        });
        return n;
      ...
      a.info(`typeof Settings: ${typeof i}`, `Settings: ${JSON.stringify(i, null, 2)}`);
    ...
    }("DualSubs", [["YouTube", "Netflix", "BiliBili", "Spotify"].includes(e) ? e : "Universal", "Composite", "API"], c);
    a.logLevel = s.LogLevel;
    let f = d.searchParams?.get("subtype") ?? s.Type;
    let b = [d.searchParams?.get("lang")?.toUpperCase?.() ?? s.Languages[0], (d.searchParams?.get("tlang") ?? i?.tlang)?.toUpperCase?.() ?? s.Languages[1]];
    a.info(`Type: ${f}`, `Languages: ${b}`);
    let y = {};
    let x = [];
    switch (f) {
      case "Official":
        ...
        switch (e) {
          default:
            {
              ...
              let d;
              N = $request.url;
              C = i.Playlists.Subtitle;
              T = 0;
              a.log("☑️ getSubtitlesCache");
              t = "";
              s = [];
              n = 0;
              C?.forEach((e, l) => {
                if (Array.isArray(e) && e?.some((e, t) => !!N.includes(e || null) && (n = t, a.debug(`subtitlesIndex: ${n}`), true))) {
                  t = l;
                  s = e;
                }
              });
              a.log("✅ getSubtitlesCache", `subtitlesPlaylistURL: ${t}`);
              let {
                subtitlesPlaylistURL: h
              } = {
                subtitlesPlaylistURL: t,
                subtitles: s,
                subtitlesIndex: n
              };
              S = h;
              k = i.Playlists.Master;
              $ = b;
              a.log("☑️ getPlaylistCache");
              l = "";
              r = {};
              o = 0;
              k?.forEach((e, t) => {
                $?.forEach(s => {
                  if (Array.isArray(e?.[s])) {
                    let n = e?.[s];
                    if (n?.some((e, t) => !!S.includes(e?.URI || e?.OPTION?.URI || null) && (o = t, a.debug(`subtitlesPlaylistIndex: ${o}`), true))) {
                      l = t;
                      r = e;
                    }
                  }
              ...
              a.log("✅ getPlaylistCache", `masterPlaylistURL: ${JSON.stringify(l)}`);
              let {
                masterPlaylistURL: f,
              ...
              v = f;
              w = y;
              E = i.Playlists.Master;
              A = i.Playlists.Subtitle;
              P = b;
              a.log("☑️ getSubtitlesArray");
              g = E?.get(v) || {};
              u = g?.[P[0]]?.[w]?.URL || g?.[P[0]]?.[0]?.URL;
              c = g?.[P[1]]?.[w]?.URL || g?.[P[1]]?.[0]?.URL;
              a.debug(`subtitlesPlaylistURL0: ${u}, subtitlesPlaylistURL1: ${c}`);
              m = A.get(u) || [];
              d = A.get(c) || [];
              a.log("✅ getSubtitlesArray");
              let {
                subtitlesURIArray0: O,
                subtitlesURIArray1: L
              } = {
                subtitlesURIArray0: m,
                subtitlesURIArray1: d
              };
              if (L.length) {
                a.debug(`subtitlesURIArray1.length: ${L.length}`);
                let t = p?.[p?.length - 1] ?? function (e, t) {
                  let s;
                  a.log("☑️ Get Subtitles FileName", `url: ${e}`);
                  switch (t) {
                    case "Apple":
                      s = request.url.match(/.+_(subtitles(_V\d)?-\d+\.webvtt)\?(.*)subtype=/)[1];
                      break;
                    case "Disney+":
                      s = request.url.match(/([^\/]+\.vtt)\?(.*)subtype=/)[1];
                      break;
                    case "Hulu":
                      s = request.url.match(/.+_(SEGMENT\d+_.+\.vtt)\?(.*)subtype=/)[1];
                      break;
                    default:
                      s = null;
                  }
                  a.log("✅ Get Subtitles FileName", `fileName: ${s}`);
                  return s;
                }($request.url, e);
                a.debug(`fileName: ${t}`);
                x = function (e, t, s = [], n = []) {
                  a.log("☑️ Construct Subtitles Queue", `fileName: ${t}`);
                  let l = [];
                  a.debug(`VTTs1.length: ${s.length}`, `VTTs2.length: ${n.length}`);
                  let r = s.findIndex(e => e?.includes(t));
                  a.debug(`Index1: ${r}`);
                  switch (n.length) {
                    case 0:
                      a.info("长度为 0");
                    ...
                    default:
                      {
                        a.info("长度不等，需要计算");
                        let t = (r + 1) / s.length;
                        a.debug(`Position1: ${t}`, `Index2: ${r}/${s.length}`);
                        let i = Math.round(t * n.length - 1);
                        a.debug(`Position2: ${t}`, `Index2: ${i}/${n.length}`);
                        let o = Math.abs(n.length - s.length);
                        let g = Math.min(r, i);
                        let u = Math.max(r, i);
                        a.debug(`diffLength: ${o}`, `BeginIndex: ${g}`, `EndIndex: ${u}`);
                        let c = n.slice(Math.max(0, g - o), Math.max(u, u + o) + 1);
                        a.debug(`nearlyVTTs: ${JSON.stringify(c)}`);
                        c.forEach(a => {
                          let t = {
                            url: a,
                            headers: e.headers
                  ...
                  a.log("✅ Construct Subtitles Queue");
                  return l;
                }($request, t, O, L);
              }
              break;
          ...
          case "YouTube":
            a.info("YouTube");
            if (d.searchParams.get("tlang") === undefined) {
              a.info("未选择翻译语言，跳过");
            } else {
              a.info("已选择翻译语言");
              s.Tolerance = 100;
              ...
              if (s.ShowOnly === true) {
                ...
                a.info("生成双语字幕");
                d.searchParams.set("lang", i.Playlists.Subtitle.get(d.searchParams.get("v")) || d.searchParams.get("lang"));
                d.searchParams.delete("tlang");
                let e = {
                  url: d.toString(),
    ...
    switch (h) {
      ...
      case "application/x-plist":
        y = g.parse($response.body);
        await Promise.all(x.map(async e => {
          let a = await n(e).then(e => g.parse(e.body));
          y = new m(s).timedText(y, a, d.searchParams.get("kind"));
        }));
        $response.body = g.stringify(y);
        break;
      case "text/vtt":
      case "application/vtt":
        y = u.parse($response.body);
        await Promise.all(x.map(async e => {
          let a = await n(e).then(e => u.parse(e.body));
          y = new m(s).webVTT(y, a);
        }));
        $response.body = u.stringify(y);
        break;
      case "text/json":
      case "application/json":
        y = JSON.parse($response.body ?? "{}");
        await Promise.all(x.map(async e => {
          let a = await n(e).then(e => JSON.parse(e.body));
          y = new m(s).JSON(y, a, d.searchParams.get("kind"));
        }));
